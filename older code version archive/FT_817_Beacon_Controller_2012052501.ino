...
// K3NG Yaesu FT-817 Beacon Controller
//
...
#define CODE_VERSION "2012052501"

#define FEATURE_SERIAL
#define FEATURE_RIG_CONTROL
//#define DEBUG

#define rig_control_rx 2     //
#define rig_control_tx 3
...
#define ptt_tx_5 0
#define ptt_tx_6 0
#define analog_vin A0
#define analog_tx_1_pwr A1
#define analog_tx_2_pwr A2
...
void setup() {
  ...
  ddschip.calibrate(4294949296LL);
  #endif
...
void loop() {
  ...
  if (unit_mode == BEACON) {       // service the buffers to send the code
