...
#define CODE_VERSION "2012071301"
...
//dds ddschip(DDS9850, 8, 6, 7, 100000000LL, CLK_MULTIPLIER_OFF);     // DDS-50
dds ddschip(DDS9851, 8, 6, 7, 180000000LL, CLK_MULTIPLIER_ON);         // DDS-60
